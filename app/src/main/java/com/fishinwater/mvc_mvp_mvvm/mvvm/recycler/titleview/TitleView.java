package com.fishinwater.mvc_mvp_mvvm.mvvm.recycler.titleview;
 ...
 */
public class TitleView extends LinearLayout implements ICustomView<TitleViewViewModel> {
    private TitleViewBinding mBinding;
    private TitleViewViewModel viewViewModel;
     ...
     */
    @Override
    public void setData(TitleViewViewModel data) {
